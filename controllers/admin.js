...
exports.postAddProduct = (req, res, next) => {
    ...
    req.user.createProduct({        // createProduct method comes from sequlize association. In the app.js file, we have mentioned that product belongs to user. So User model automatically create methods. 
        title: title,               // createProduct method will create the product with the userId = user.Id;
        price: price,
        imageUrl: imageUrl,
